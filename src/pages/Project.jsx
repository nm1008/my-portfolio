...
const Project = () => {
  ...
  return (
    <section
      ...
      } transition duration-700 ease xl:h-full py-20 relative overflow-hidden px-5 md:px-48`}
    >
      <div className="m-auto sm:w-[90%] md:w-[60%] ">
        <h1 className="text-xl font-bold text-blue-500 uppercase text-center">Projects</h1>
      </div>
      ...
      <motion.div
          ...
          viewport={{ once: true }}
          className="border-r-8 border-blue-400 bg-white rounded-xl shadow-md xxl:flex  gap-5 mt-10 flex flex-wrap items-center md:flex-nowrap">
          <a
            className=""
            href="#"
            target="_blank" rel="noreferrer">
            <img
              className="w-full md:w-full h-auto object-cover border-slate-600  "
          ...
          <div className="w-full xl:mt-0 sm:mt-5 flex flex-col space-y-5 py-3">
            ...
            <motion.p
              ...
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptates impedit vel id expedita aliquam a repudiandae, officia, cupiditate, molestiae magnam quis vero. Omnis, quaerat sequi.
            </motion.p>
