...
const Header = () => {
  ...
  return (
    <header className="z-50 flex xl:flex justify-center fixed bottom-0 w-full xl:top-40 xl:right-6 xl:h-[60vh] xl:w-[70px] bg-red-500 xl:rounded-md bg-clip-padding backdrop-filter backdrop-blur-2xl bg-opacity-0 border-t xl:border border-blue-300 p-5">
