...
const Project = () => {
  ...
  return (
    <section
      ...
      } transition duration-700 ease xl:h-full py-20 relative overflow-hidden px-5 lg:px-48 md:px-14`}
    >
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="border-r-8 border-blue-400 bg-white rounded-xl shadow-md xxl:flex  gap-5 mt-10 flex flex-wrap items-center xl:flex-nowrap"
      >
        <a className="" href="#" target="_blank" rel="noreferrer">
          <img
            className="w-full md:w-full h-auto object-cover md:rounded-l-xl rounded-l-md border-slate-600  "
        ...
        <div className="w-full xl:mt-0 sm:mt-5 flex flex-col space-y-5 py-3">
          ...
          >
            ...
            impedit vel id expedita aliquam a repudiandae, officia, cupiditate,
            molestiae magnam quis vero. Omnis, quaerat sequi.
          </motion.p>
